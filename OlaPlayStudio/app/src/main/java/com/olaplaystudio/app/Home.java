...
import com.olaplaystudio.global.Utility;
...
public class Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songsAdapter = new SongsAdapter(context, songsDTOList());
    ...
    private List<SongsDTO> songsDTOList() {
        List<SongsDTO> songsDTOs = new ArrayList<>();
        SongsDTO songsDTO = new SongsDTO();
        songsDTO.setArtistsName("Rahat Fateh Ali Khan, Momina Mustehsan");
        songsDTO.setSongTitle("Afreen Afreen");
        for (int i = 0; i < 10; i++) {
